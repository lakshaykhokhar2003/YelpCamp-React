...
import NewCampground from "./pages/Campground/NewCampground/NewCampground";
import Campground from "./pages/Campground/Campground";
import Error from "./pages/Error";
import EditCampground from "./pages/Campground/EditCampground/EditCampground";
...
function App() {
    return <Provider store={store}>
        <>
            ...
            <ToastContainer transition={Flip} position="top-center" limit={2} theme="dark"/>
        </>
    </Provider>;
}
